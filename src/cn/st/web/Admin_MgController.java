...
public class Admin_MgController {
	...
	public String  save(Admin admin,HttpSession session,
		@RequestParam("name1111") String name1111) {
	...
	public String update(@PathVariable("ad_id") int ad_id,Model model) {
	...
	public String delete(@PathVariable("ad_id")int ad_id,HttpSession session) {
	...
	public String findByteacher(@PathVariable("ad_id") int ad_id,Model model) {
		Admin admin=adminService.findById(ad_id);
		model.addAttribute("admin",admin);
