...
<body>
   ...
   <li><b style="color:red">${name}</b>，欢迎您登录</li>
    ...
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">学生注册</a></li> 
  	</ul>
    </div> 
  	<div id="tab1" class="tabson">
 <form  action="${ctx}/studentReg" method="post"  onsubmit="return validate()">
    <ul class="forminfo">
    ...
    <li><label>系别<b>*</b></label>
        <select name=department id="department" style="width:120px;border:1px solid gray;border-radius:10px;color:gray;">
     ...
     <li><label>教师<b>*</b></label>
        <select name="teacher_id" id="teacher_id" style="width:120px;border:1px solid gray;border-radius:10px;color:gray;">
          <c:forEach items="${list}" var="item">
			<option value="${item.ad_id}" style="sbackground-color:green;">${item.name}</option>
	      </c:forEach>
		</select>
    </li>
