...
<body>
   ...
   <li><b style="color:red">${stuName}</b>，欢迎您登录</li>
    ...
    <ul class="forminfo">
    <li><label>学号<b>*</b></label><input name="stu_num" id="stu_num" type="text" class="dfinput" value="${item.stu_num}"  style="width:518px;" /></li>
    <li><label>姓名<b>*</b></label><input name="stu_name" id="stu_name" type="text" class="dfinput" value="${item.stu_name}"   style="width:518px;"/></li>
    <li><label>密码<b>*</b></label><input name="psw" id="psw" type="password" class="dfinput" value="${item.psw}"   style="width:518px;"/></li>
    <li><label>系别<b>*</b></label><input name="department" id="department" type="text" class="dfinput" value="${item.department}"   style="width:518px;"/></li>
    <li><label>班级<b>*</b></label><input name="classT" id="classT" type="text" class="dfinput" value="${item.classT}"   style="width:518px;"/></li>
    <li><label>电话<b>*</b></label><input name="phone" id="phone" type="text" class="dfinput" value="${item.phone}"  style="width:518px;"/></li>
    <li><label>邮箱<b>*</b></label><input name="eamil" id="eamil" type="text" class="dfinput" value="${item.eamil}"   style="width:518px;"/></li>
    <li><label>性别<b>*</b></label><input name="gender" id="gender" type="text" class="dfinput" value="${item.gender}"   style="width:518px;"/></li>
    <li style="margin-top:19px;"><label>&nbsp;</label>
	<form action="${ctx}/updateByMy/${item.stu_id}" name="form" method="get">
	  <input  type="submit" class="btn"  value="修改"/>
	</form>
    </li>
    <li style="position:absolute;left:230px;bottom:14px;"><label>&nbsp;</label><input name="" type="button" class="btn" onclick="history.go(-1)" value="返回"/></li>
    </ul>
     </c:forEach>
    </div>
	</div> 
