...
<body>
    ...
    <li style="margin-left:20px;"><label>资料类型<b>*</b></label>
        <select name=data_type id="data_type" style="width:120px;border:1px solid #F4F4F4;border-radius:10px; margin-top:10px;">
     ...
     <li style="margin-left:20px;"><label>对应视频<b>*</b></label>
           <select name="vedio_name" id="vedio_name" style="width:120px;border:1px solid #F4F4F4;border-radius:10px;margin-top:10px;">
						<option value="" >---请选择---</option>
    ...
    <li style="margin-left:20px;"><label>资料上传<b>*</b></label>
         <input type="file" name="upFile" id="upfile" style="margin-top:10px;"/>
    </li>
