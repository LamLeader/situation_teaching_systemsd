  ...
  $(".tip").fadeOut(100);
   ...
   <script type="text/javascript">
     ...
     function lookAnswer(){
     	var up_id=$("#up_id").val();
     	alert("up_id:"+up_id);
     	/* window.location.href="${pageContext.request.contextPath}/onlinelibrary/list3?up_id="+up_id; */
     }
...
<body>
    ...
    <div style="margin-left: 30px; margin-right: 0px">
		...
		<%--  <div style="margin-top: 100px;border:1px solid gray;">
		    <input type="button" id="lookAnswer" onclick="lookAnswer()"  class="scbtn" value="查看答案"  />
		 </div> --%>
    </form>	
    </div>
    <script type="text/javascript">
