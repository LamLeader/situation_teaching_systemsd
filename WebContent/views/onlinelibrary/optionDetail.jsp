...
<body>
    ...
    <li style="border:1px solid gray;border-radius:10px;display:inline;height:50px;"><b style="color:black;">请选择对应视频*</b>
         <select name="up_id" id="up_id" style="width:120px;border:1px solid gray;border-radius:10px;" >
